package br.com.allurafood.pagamentos.controller;
...
import br.com.allurafood.pagamentos.service.PagamentoService;
...
public class PagamentoController {
    ...
    public ResponseEntity<PagamentoDTO> cadastrar(@RequestBody @Valid PagamentoDTO dto, UriComponentsBuilder uriBuilder) {
        ...
        URI endereco = uriBuilder.path("/pagamentos/{id}").buildAndExpand().toUri();
